...
use crate::audit;
use crate::cli::{
    ChangeCommand, Cli, Command, DoctorArgs, GraphArgs, PrCommand, PrCreateArgs, PrPushArgs, PrUpdateArgs, RepoCommand,
...
fn ensure_pr_deprecated(args: PrCreateArgs, runner: &dyn CommandRunner) -> Result<RunResult> {
    eprintln!(
