...
// Notifications toolbar window. Distinct from `WorkAttentionItem` above, which
// is the legacy engine-raised *operational* alert store.
// ===========================================================================
...
// MARK: - GitHub OAuth device-flow auth
